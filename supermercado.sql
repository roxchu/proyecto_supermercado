...
(1, 1, 0, '2025-10-26 18:19:26', 'Pendiente', 0.00, 14500.00),
(2, 2, 0, '2025-10-26 19:19:50', 'Pendiente', 0.00, 0.00);
...
--
ALTER TABLE `detalle_carrito`
  ADD CONSTRAINT `FK_Detalle_Carrito` FOREIGN KEY (`id_carrito`) REFERENCES `carrito` (`id_carrito`) ON DELETE CASCADE;
...
ALTER TABLE `detalle_venta`
  ...
  ADD CONSTRAINT `FK_DetalleVenta_Venta` FOREIGN KEY (`id_venta`) REFERENCES `venta` (`id_venta`) ON DELETE CASCADE;
