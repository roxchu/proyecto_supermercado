...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // ---------------------------
  // CARRUSEL Y CARGA DE PRODUCTOS - DESHABILITADO (USANDO SISTEMA MODULAR)
  // ---------------------------
  function inicializarCarrusel() {
    // Función deshabilitada - ahora se usa el sistema modular js/app.js
    console.log('⚠️ Carrusel legacy deshabilitado - usando sistema modular');
    return;
  ...
  function cargarProductos() {
    // Función deshabilitada - ahora se usa ProductsLoader en js/modules/
    console.log('⚠️ Carga de productos legacy deshabilitada - usando sistema modular');
    return;
  }
  ...
  // Carga productos deshabilitada - se usa sistema modular
  console.log('⚠️ Sistema legacy deshabilitado - usando js/app.js');
  // cargarProductos(); // Comentado - ahora usa ProductsLoader
  
  // El contador del carrito se actualiza automáticamente en carrito.js
  console.log('✅ Inicialización legacy completada');
