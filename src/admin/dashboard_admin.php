...
try {
    ...
    // Obtenemos los productos con imagen principal
    $stmt_productos = $pdo->query("SELECT p.Id_Producto, pi.url_imagen as imagen_principal, p.Nombre_Producto, p.precio_actual, p.precio_anterior, p.Stock, p.Descripcion, p.Id_Categoria, c.Nombre_Categoria 
                                   FROM producto p 
    ...
    foreach ($productos as $i => $producto) {
        ...
        // Aseguramos que imagen_principal no sea null para el JS
        $productos[$i]['imagen_url'] = $producto['imagen_principal'] ?? ''; 
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo htmlspecialchars($producto['imagen_url'] ?: 'https://via.placeholder.com/60x60'); ?>" alt="Producto" width="60" height="60"></td>
